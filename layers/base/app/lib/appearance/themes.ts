// Standalone theme token data (light+dark CSS vars) for the lightweight
// appearance engine. Self-contained (no external deps) so this whole
// app/lib/appearance/ folder can be copied verbatim into pmone & pmone-events.
// Source: levenium registry/themes.ts (shadcn token palettes, MIT).
...
export const THEMES: AppearanceTheme[] = [
  {
    name: "neutral",
    title: "Neutral",
    type: "registry:theme",
