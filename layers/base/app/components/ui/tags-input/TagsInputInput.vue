...
<template>
  ...
  <TagsInputInput
    ...
    :class="
      cn(
        'cn-combobox-chip-input placeholder:text-placeholder min-w-16 flex-1 bg-transparent px-0 py-0 outline-none disabled:cursor-not-allowed disabled:opacity-50',
        props.class
      )
    "
  />
