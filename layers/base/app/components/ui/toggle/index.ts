...
export const toggleVariants = cva(
  "cn-toggle group/toggle hover:bg-muted inline-flex cursor-pointer items-center justify-center whitespace-nowrap outline-none focus-visible:ring-3 disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
...
export const toggleCardClass =
  "cursor-pointer rounded-xl border border-border bg-background outline-none transition-[color,box-shadow] hover:bg-muted disabled:opacity-50 focus-visible:border-ring focus-visible:ring-ring focus-visible:ring-[1px] data-[state=on]:border-primary data-[state=on]:bg-primary/5 data-[state=on]:text-foreground data-[state=on]:ring-1 data-[state=on]:ring-primary";
