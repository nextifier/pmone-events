...
/**
 * Month range picker — popover trigger (like DatePicker) around reka-ui's
 * MonthRangePickerRoot grid. v-model is a reka-native `DateRange`
...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    size: "default",
    align: "start",
    placeholderText: "Pick a month range",
  },
);
...
function fmt(value: DateValue): string {
  return formatter.custom(toDate(value), { month: "short", year: "numeric" });
}
...
<template>
  <Popover v-model:open="isOpen" :modal="false">
    ...
    >
      ...
      >
        <MonthRangePickerHeader class="relative flex min-h-8 items-center justify-center">
          <MonthRangePickerPrev
            :class="
              cn(
                buttonVariants({ variant: 'ghost' }),
          ...
          <MonthRangePickerHeading class="text-sm font-medium select-none" />
          <MonthRangePickerNext
            :class="
              cn(
                buttonVariants({ variant: 'ghost' }),
        ...
        <MonthRangePickerGrid class="mt-3 w-full border-collapse">
          <MonthRangePickerGridBody>
            <MonthRangePickerGridRow
            ...
            >
              <MonthRangePickerCell
                ...
                class="flex-1"
              >
                <MonthRangePickerCellTrigger :month="cell" :class="cellClass">
                  {{ monthLabel(cell) }}
                </MonthRangePickerCellTrigger>
              </MonthRangePickerCell>
            </MonthRangePickerGridRow>
