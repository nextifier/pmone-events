...
<template>
  ...
  >
    ...
    <button
      ...
      class="text-muted-foreground hover:bg-muted hover:text-foreground focus-visible:ring-ring/50 ml-auto rounded-sm p-0.5 transition-colors focus-visible:ring-2 focus-visible:outline-none"
      @mousedown.prevent
      @click="clear"
    >
