    ...
    :class="
      cn(
        ...
        isLiteral
          ...
          : 'cn-input hover:bg-muted/50 focus:bg-muted focus:text-foreground not-focus:data-[placeholder]:text-muted-foreground data-[invalid]:border-destructive-foreground/50 data-[invalid]:bg-destructive/10 data-[invalid]:text-destructive-foreground squircle inline-flex size-8 items-center justify-center rounded-sm p-0 shadow-none',
