<template>
  <div class="bg-muted/30 dark:bg-background min-h-[70dvh]">
    <div class="mx-auto w-full max-w-2xl px-4 pt-6 pb-12 sm:pt-8 sm:pb-16">
      ...
      <!-- Status card (closed / success / already submitted) -->
      <div
      ...
      >
        ...
        <p
          class="text-muted-foreground mx-auto mt-2 max-w-sm text-sm tracking-tight sm:text-base"
        >
          {{ statusCard.message }}
        </p>
      </div>
...
// One shared card for closed / success / already-submitted states.
