export default {
  ...
  contact: {
    ...
    disclaimerExhibitor:
      "Kirim form ini bukan berarti langsung terdaftar sebagai exhibitor. Tim sales kami akan menghubungi untuk memberikan info booth, harga, dan detail lainnya.",
  },
  eventStatus: {
  ...
  faq: {
    ...
    description:
      "Jawaban untuk pertanyaan seputar IOITE, tiket, exhibitor, dan lainnya.",
  ...
  pages: {
    ...
    news: {
      title: "Berita",
      description:
        "Info, insight, dan tren terbaru dari dunia corporate engagement dan incentive travel.",
    },
    ticketPolicy: {
    ...
    partners: {
      title: "Partner Kami",
      description:
        "Terima kasih untuk semua partner, sponsor, dan media yang sudah mendukung acara ini.",
    },
    terms: {
    ...
    winner: {
      ...
      description:
        "Pilih pemenang secara acak. Masukkan nama, putar slot, tentukan pemenang. Cocok untuk kontes, giveaway, dan event.",
    },
  },
  about: {
