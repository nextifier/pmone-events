export default {
  ...
  contact: {
    ...
    disclaimerExhibitor:
      "放心，提交表单不等于确认参展。我们先收集联系方式，销售团队会把展位和价格等信息发给你。",
  },
  eventStatus: {
    startsIn: "距开幕还有",
  },
  ...
  faq: {
    ...
    items: {
      ...
      "1": {
        q: "怎么获取门票？",
        a: '<p>在官网点击 <a href="/tickets">领取门票</a> 按钮，按流程注册即可。电子门票会发到你的 Email 和 WhatsApp。</p>',
      },
      "2": {
        q: "门票多少钱？",
        a: '<p>价格因票种和购买时间而异。最新价格请查看 <a href="/tickets">门票页面</a>。</p>',
      },
      "3": {
        q: "买了票去不了，能退吗？",
  ...
  pages: {
    ...
    faq: {
      title: "常见问题",
      description:
        "关于 {appName} 的常见问题和解答。门票、活动详情、参展合作等。",
    },
    links: {
      title: "快捷链接",
