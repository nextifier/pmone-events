    ...
    return {
      list: [
        ...
        },
        {
          ...
          a: `
            <p>The event is open to the public. Whether you're an aspiring entrepreneur, business owner, investor, or simply interested in exploring business opportunities, you're welcome to attend!</p>
          `,
        },
        {
          q: "What brands will be exhibiting at the event?",
          a: `
            <p>We feature a diverse range of brands from various business categories. You can view the list of exhibitors on our <a href="/brands">Brands page</a>. The list will be updated as we get closer to the event date.</p>
          `,
        },
        {
          q: "How can I become an exhibitor?",
          a: `
            <p>To become an exhibitor, please visit our <a href="/book-space">Exhibitor Registration page</a> or contact our team via <a href="${whatsappLink}" target="_blank">WhatsApp</a> for more information about booth packages and availability.</p>
          `,
        },
        {
          q: "Are there any seminars or workshops at the event?",
          a: `
            <p>Yes! We organize various seminars, workshops, and networking sessions. Check our <a href="/rundown">Rundown page</a> for the complete schedule of activities and speaker sessions.</p>
          `,
        },
        {
        ...
        },
        {
          ...
          a: `
            <p>All attendees must comply with our event rules and regulations, including following instructions from event staff and security personnel. Please read our <a href="/event-policy">Event Policy</a> before attending.</p>
          `,
        },
        {
