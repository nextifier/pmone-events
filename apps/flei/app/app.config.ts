const app = {
  ...
  shortName: "FLEI",
  // Binds to PM One project "flei" (Franchise & License Expo Indonesia). Folder name may differ. See root CLAUDE.md "App ↔ PM One Project Map".
