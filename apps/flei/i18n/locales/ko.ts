export default {
  ...
  faq: {
    ...
    items: {
      ...
      "1": {
        q: "티켓은 어떻게 받나요?",
        a: '<p>공식 웹사이트에서 받을 수 있어요. <a href="/tickets">티켓 받기</a> 버튼을 클릭하고 등록하면 전자 티켓이 Email과 WhatsApp으로 가요.</p>',
      },
      "2": {
        q: "티켓 가격이 얼마예요?",
        a: '<p>종류와 구매 시기에 따라 달라요. <a href="/tickets">티켓 페이지</a>에서 최신 가격을 확인하세요. 얼리버드 할인도 놓치지 마세요!</p>',
      },
      "3": {
