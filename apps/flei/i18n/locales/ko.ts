export default {
  ...
  contact: {
    ...
    formTitle: "문의 양식",
    description:
      "티켓, 전시 참가, 파트너십 등 궁금한 점이 있으면 연락해 주세요.",
    name: "이름",
    jobTitle: "직책",
    brandName: "브랜드명",
    products: "상품",
    ...
    disclaimerExhibitor:
      "걱정 마세요. 이 양식을 제출해도 바로 전시 참가가 확정되는 건 아니에요. 부스 옵션이나 가격 안내를 위해 연락처가 필요해요.",
  ...
  about: {
    title:
      "<span class='text-accent'>수백 가지 사업 기회</span>가 한 건물 안에.",
    description:
      "FLEI는 검증된 프랜차이즈와 라이선스 브랜드를 한곳에 모은 박람회예요. 이곳저곳 알아볼 필요 없이, 직접 와서 비교하고 내 사업을 골라보세요.",
  },
  mainPrograms: {
    title:
      "<span class='text-outline'>주요</span> <span class='text-accent'>프로그램</span>",
    description:
      "전시만 있는 게 아니에요. {appName}에서는 비즈니스 컨퍼런스, 코칭, 매칭 등 다양한 프로그램이 진행돼요.",
    items: {
      "0": {
        title: "비즈니스 컨퍼런스",
        description:
          'FLEI 메인 무대. "Grab-Run-Grow" 세션에서 CEO와 창업자들이 자기 전략을 직접 얘기해요. 교과서가 아니라 실전 경험이에요.',
      },
      "1": {
        title: "비즈니스 코칭",
        description:
          "사업 관련 고민이 있으세요? 전문가와 무료로 1:1 상담받을 수 있어요. 구체적인 문제를 가져오면, 맞춤 솔루션을 받아가세요.",
      },
      "2": {
        title: "비즈니스 매칭",
        description:
          "행사 전에 미리 전시 참가사나 투자자와 미팅을 잡을 수 있어요. 당일에 시간 낭비 없이 필요한 사람을 바로 만나세요.",
      },
      "3": {
        title: "실전 마스터클래스",
        description:
          "디지털 마케팅, 운영 효율화, 브랜드 관리. 매일 현장에서 이걸 하는 사람들에게 직접 배우는 워크숍이에요. 좌석 한정.",
      },
      "4": {
        title: "에코프리너 챌린지",
        description:
          "지속 가능한 사업 아이디어가 있다면, 투자자 앞에서 발표해 보세요. 전문가 피드백도 받고 상금도 노릴 수 있어요.",
      },
      "5": {
        title: "인스피레이션 스테이지",
        description:
          "맨바닥에서 시작한 창업자들의 진짜 이야기를 들어보세요. 실패담, 성공 비결, 그 과정에서 배운 것들까지.",
      },
    },
  },
  businessSegments: {
    ...
    items: {
      "0": {
        title: "프랜차이즈",
        description:
          "검증된 프랜차이즈 브랜드가 참가해요. F&B부터 리테일까지, 교육과 지원 시스템을 포함해서 비교해 볼 수 있어요.",
      },
      "1": {
        title: "비즈니스 기회",
        description:
          "처음 사업을 시작하는 분에게 딱 맞아요. 앞으로 프랜차이즈로 성장할 수 있는 유망한 사업 아이템을 찾아보세요.",
      },
      "2": {
        title: "리테일 테크 솔루션",
        description:
          "매장 운영 효율과 고객 경험을 높여주는 기술이에요. POS 시스템부터 데이터 분석까지 다양하게 만나볼 수 있어요.",
      },
      "3": {
        title: "라이선싱 & 코브랜딩",
        description:
          "인기 캐릭터나 유명 브랜드의 라이선스를 활용해서 제품 경쟁력을 높여보세요. 맞는 파트너를 여기서 찾을 수 있어요.",
      },
      "4": {
        title: "디스트리뷰터",
        description:
          "인도네시아 유통 네트워크에 진출하세요. 에이전트, 도매, 온라인 파트너를 찾는 브랜드와 연결해 드려요.",
      },
    },
  },
  partnerships: {
    ...
    exhibitor: {
      title: "전시업체 등록",
      description:
        "사업 기회를 찾으러 온 수천 명의 관람객에게 브랜드를 직접 보여줄 수 있어요.",
      cta: "부스 예약하기",
    },
    sponsor: {
      title: "스폰서 등록",
      description:
        "프랜차이즈 업계의 핵심 인물들이 모이는 자리에서 브랜드를 알리세요.",
      cta: "스폰서 문의",
    },
    mediaPartner: {
      title: "미디어 파트너 등록",
  ...
  visitorCta: {
    title:
      '티켓을 <span class="text-accent">받으세요.</span> 사업 기회는 <span class="text-accent">무한.</span>',
    description:
      "수천 명의 사업가, 투자자가 모이는 자리예요. 등록은 1분이면 끝나요.",
    cta: "티켓 받기",
  },
  mediaCoverage: {
    title: "미디어 보도",
  ...
  brandList: {
    title: "브랜드",
    description:
      "다양한 카테고리의 프랜차이즈 및 라이선스 브랜드를 둘러보세요.",
  },
  bookSpace: {
    title: "전시 참가 신청",
    description:
  ...
  faq: {
    title: "자주 묻는 질문",
    description:
      "FLEI 티켓, 전시 참가, 프로그램 등에 대한 질문과 답변을 모았어요.",
  ...
  pages: {
    home: {
      title:
        "Franchise & License Expo Indonesia (FLEI) · 인도네시아 최대 프랜차이즈 박람회",
      description:
        "자카르타 FLEI에서 프랜차이즈 브랜드를 만나고, 비즈니스 세미나에 참석하고, 업계 네트워크를 넓혀보세요.",
    },
    brands: {
      title: "브랜드",
      description:
    ...
    programs: {
      title: "주요 프로그램",
      description:
        "{appName}의 전시, 컨퍼런스, 세미나, 비즈니스 매칭 등 주요 프로그램을 확인하세요.",
    },
    contact: {
      title: "문의하기",
      description:
    ...
    faq: {
      title: "FAQ",
      description:
        "{appName} 티켓, 행사 정보, 파트너십 등 자주 묻는 질문을 확인하세요.",
    },
    links: {
      title: "링크",
    ...
    news: {
      title: "뉴스",
      description:
        "비즈니스와 프랜차이즈 업계의 최신 소식과 트렌드를 확인하세요.",
    },
    ticketPolicy: {
      title: "티켓 정책",
    ...
    eventPolicy: {
      title: "행사 정책",
      description:
        "{appName} 참가자 및 전시 참가사를 위한 규정과 안내 사항이에요.",
    },
    partners: {
      title: "파트너",
      description:
    ...
    winner: {
      title: "랜덤 추첨기",
      description:
        "이름을 입력하고 슬롯을 돌려서 당첨자를 뽑아보세요. 콘테스트, 경품 이벤트에 딱이에요!",
    },
  },
};
