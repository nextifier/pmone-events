      ...
      >
        ...
        >
          ...
          <div class="flex flex-col items-start">
            ...
            <h1
              class="text-foreground mt-5 text-[clamp(3.4rem,4vw,6rem)] !leading-[1.1] font-semibold tracking-[-0.08em] text-balance"
              v-html="content.title"
            ></h1>

            <p
              class="text-foreground mt-5 max-w-xl text-base tracking-tight text-pretty sm:text-lg"
            >
              {{ content.description }}
            </p>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span
                    class="before:gradient-gold relative text-white before:absolute before:-inset-2 before:z-[-1] before:-skew-x-16"
                    >{{ event.month }}</span
                  >
