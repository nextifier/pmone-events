  ...
  state: () => ({
    ...
    components: {
      hero: {
        ...
        bannerHero: [
          {
            subHeadline: "Your Free Pass to a Better Home!",
            content: `
              <p>Get free access to the complete blueprint for your renovation: hundreds of brands, expert design consultations, and the latest trends in home improvement.</p>
            `,
            cta: {
          ...
          },
          {
            ...
            content: `
              <p>Position your brand in front of thousands of homeowners, architects, and designers who are actively sourcing for their next renovation project. Let's build success together.</p>
            `,
            cta: {
          ...
          },
          {
            ...
            content: `
              <p>Bring your floor plan! Get personalized advice from professional interior designers and Fengshui experts to create a harmonious and functional space.</p>
            `,
            cta: {
              label: "See All Event Highlights",
              link: "/programs",
            },
          },
          {
            ...
            content: `
            <p>Follow our Instagram for daily renovation inspiration, exhibitor spotlights, and special giveaways leading up to the event. Don't miss a single update!</p>
          `,
            cta: {
