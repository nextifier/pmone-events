export default {
  ...
  contact: {
    description:
      "チケット、出展、パートナーシップなど、何でも気軽に聞いてください。",
    products: "商品",
    successTitle: "送信完了！お問い合わせありがとうございます。",
    successMessage: "担当者からEmailまたはWhatsAppで折り返しご連絡します。",
    disclaimerDefault:
      "正しいEmailアドレスと電話番号を入力してください。担当者からすぐにご連絡します。",
    disclaimerExhibitor:
      "フォーム送信 = 出展確定ではありません。ブースの空き状況や料金などをご案内するために、連絡先をお聞きしています。",
  ...
  mainPrograms: {
    title: "メインプログラム",
    description:
      "展示、トークショー、コスプレ大会まで。{appName}を見逃せない理由がここにあります。",
  },
  partnerships: {
    title: "一緒にイベントを盛り上げよう",
    description:
      "{appName}に参加して、ポップカルチャーファンにブランドを届けましょう。新しいパートナーとの出会いやネットワーク拡大のチャンスです。",
    exhibitor: {
      title: "出展登録",
      description:
        "ブランドや商品を持っている方、熱いファンの前で直接アピールしませんか？",
      cta: "ブース予約",
    },
    sponsor: {
      title: "スポンサー登録",
      description:
        "インドネシア最大級のポップカルチャーイベントで、コアなファン層にリーチ。",
      cta: "スポンサー申込",
    },
    mediaPartner: {
      title: "メディアパートナー登録",
      description:
        "ポップカルチャー最大イベントの独占取材。一緒にストーリーを届けましょう。",
      cta: "メディア申込",
    },
    reservedSpace: {
  ...
  visitorCta: {
    ...
    description:
      "{appName}がパワーアップして帰ってくる！レジェンドゲストとの出会い、最高のステージ、忘れられない思い出。チケットは今すぐ。",
    cta: "チケット購入",
  },
  mediaCoverage: {
    title: "メディア掲載実績",
  ...
  bookSpace: {
    title: "出展者登録",
    description:
      "{appName}でブースを確保。何千人ものポップカルチャーファンとコレクターにブランドをアピールしよう。",
  },
  faq: {
    title: "よくある質問",
    description:
      "チケット、イベント詳細、出展情報など、よくある質問をまとめました。",
    ...
    items: {
      ...
      "1": {
        q: "チケットはどこで買えるの？",
        a: '<p>公式サイトの<a href="/tickets">チケット購入</a>ボタンから手続きできます。購入後、EチケットがEmailとWhatsAppに届きます。</p>',
      },
      "2": {
        q: "チケットはいくら？",
        a: '<p>チケットの種類（1日券、通し券、VIPなど）や時期によって異なります。最新価格は<a href="/tickets">チケットページ</a>をチェック。早割がお得です！</p>',
      },
      "3": {
        q: "行けなくなったら返金できる？",
      ...
      "11": {
        q: "年齢制限はある？",
        a: '<p>ファミリー向けイベントで年齢制限はありません。チケットを持つ保護者同伴のお子さまは無料入場も可能です。詳しくは<a href="/tickets">チケットページ</a>へ。</p>',
      },
      "12": {
        q: "会場に駐車場はある？",
  ...
  eventGuidelines: {
    ...
    items: {
      "0": {
        title: "不適切な衣装はNG",
        description:
          "TPOに合った服装で来てください。不快感を与える衣装はご遠慮ください。",
      },
      "1": {
        title: "ハラスメント禁止",
        description:
          "他の来場者を尊重してください。写真撮影やボディタッチは必ず相手の同意を。ハラスメント、差別、暴力は一切容認しません。",
      },
      "2": {
        title: "危険な小道具は持ち込み禁止",
        description:
          "危険物、鋭利な物、飛び道具、2m超の武器はNG。リアル系武器は必ず安全処理を。",
      },
      "3": {
        title: "通路を塞がないで",
  ...
  pages: {
    home: {
      ...
      description:
        "Indonesia Comic Conへようこそ！トイ、映画、コミック、ゲーム、コスプレ、スペシャルゲスト。ポップカルチャーの全部がここに。",
    },
    guests: {
      title: "ゲスト",
      description:
        "{appName}に誰が来る？セレブ、アーティスト、業界のレジェンドたち。スペシャルゲストのラインナップをチェック。",
    },
    brands: {
      title: "ブランド",
      description:
        "ICCの出展ブランドをチェック。コミック、コレクティブル、ゲーム、テック、ポップカルチャーグッズが勢揃い。",
    },
    rundown: {
      title: "スケジュール",
      description: "{appName}のタイムテーブルとプログラム詳細はこちら。",
    ...
    programs: {
      title: "メインプログラム",
      description:
        "展示、トークショー、コスプレ大会まで。{appName}を見逃せない理由がここに。",
    },
    contact: {
      title: "お問い合わせ",
    ...
    bookSpace: {
      title: "ブース予約",
      description:
        "{appName}でブースを確保して、ポップカルチャーファンにブランドをアピールしよう。",
    },
    ticket: {
      title: "チケット購入",
      description:
        "{appName}のチケットはこちら。日程、会場、チケットの種類をまとめてチェック。",
    },
    gallery: {
      title: "ギャラリー",
    ...
    faq: {
      title: "FAQ",
      description:
        "{appName}についてよくある質問。チケット、イベント、パートナーシップなどの情報はこちら。",
    },
    links: {
      title: "リンク",
    ...
    eventGuidelines: {
      title: "イベントガイドライン",
      description:
        "{appName}をもっと楽しむためのガイドライン。コスプレルール、マナー、大事な情報をまとめました。",
    },
    safetyAndWeaponPolicy: {
      title: "安全・武器ポリシー",
      description:
        "{appName}ではみんなの安全が最優先。小道具や武器に関するポリシーはこちら。",
    },
    antiHarassmentPolicy: {
      title: "ハラスメント防止ポリシー",
      description:
        "{appName}はすべての人が安心できる場所を目指しています。ゼロトレランスのポリシーをご確認ください。",
    },
    meetAndGreet: {
      title: "Meet & Greet",
      description:
        "{appName}のMeet & Greetで、推しのスターやクリエイターと直接会えるチャンス。",
    },
    portfolioReview: {
      title: "Portfolio Review",
      description:
        "{appName}のPortfolio Reviewで、プロから直接フィードバックをもらおう。",
    },
    raya: {
      title: "Raya Championship of Cosplay",
      description:
        "Raya Championship of Cosplayでステージに立とう！トップコスプレイヤーたちとクリエイティビティで勝負。",
    },
    specialShow: {
      title: "Special Show",
    ...
    partners: {
      title: "パートナー",
      description:
        "パートナー、スポンサー、メディアの皆さん。この応援がなければイベントは成り立ちません。ありがとうございます。",
    },
    terms: {
      title: "利用規約",
      description: "",
    ...
    winner: {
      title: "ランダム抽選",
      description:
        "名前を入れてスロットを回すだけ。コンテスト、プレゼント企画、イベントの抽選にぴったり！",
    },
  },
  guests: {
    comingSoon: "近日発表",
  ...
  portfolioReview: {
    title: "ポートフォリオレビュー",
    description:
      "アーティスト、クリエイター、アート好きのみんなへ。業界プロによるポートフォリオレビューを受けるチャンス！",
    openFor: "対象:",
    notes: "注意事項:",
    noteVenue:
      "ポートフォリオレビューは{appName}にて、{eventDate}に{eventLocation}で開催します。",
    noteContact:
      "選ばれた方にはIndonesia Comic Conから連絡があり、無料入場チケットが提供されます。",
  },
};
