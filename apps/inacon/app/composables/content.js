...
export const useContentStore = defineStore("content", {
  state: () => ({
    pages: {
      ...
      guests: {
        title: `Guests`,
        description: `Meet the stars of ${useAppConfig().event.title}! Explore our lineup of special guests, including celebrities, artists, and industry icons joining us in Jakarta.`,
      },
      brands: {
        title: `Brands`,
        description: `Explore the diverse range of brands at ${useAppConfig().event.title}, featuring the latest in comics, collectibles, gaming, tech, and pop culture products.`,
      ...
      bookSpace: {
        ...
        description: `Secure your booth at ${useAppConfig().event.title} and showcase your brand to thousands of potential customers. Join leading brands and enhance your business growth.`,
        ogImage: "/og/og-book-space.jpg",
      },
      ticket: {
        title: `Get Your Ticket`,
        description: `Get your entry tickets for the ${useAppConfig().event.title}. Find all the details you need, including dates, venue, and ticket options.`,
        ...
        bannerHero: [
          {
            ...
            content: `
      <p>The "X" in "ICC X INACON" marks both our epic crossover with INACON and our legendary 10th (X) anniversary since ICC's journey began in 2015!</p>
    `,
            img: {
...

          {
            ...
            content: `
      <p>Kaito Arjuna & Kirana Yumi joins forces with ICC's Captain Sultan.</p>
    `,
            img: {
...

          {
            ...
            content: `
      <p>Connect your brand with thousands of pop culture fans and collectors at Indonesia's largest crossover event!</p>
    `,
            img: "",
            cta: {
              label: "Book Space",
