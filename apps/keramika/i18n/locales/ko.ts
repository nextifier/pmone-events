export default {
  ...
  contact: {
    ...
    disclaimerDefault:
      "정확하고 연락 가능한 Email 주소와 전화번호를 입력해 주세요. 담당자가 곧 연락드릴게요.",
    disclaimerExhibitor:
      "걱정 마세요. 이 양식을 제출한다고 바로 전시 참가가 확정되는 건 아니에요. 부스 옵션, 가격 등 자세한 안내를 위해 연락처가 필요해요.",
  },
  nav: {
    Email: "Email",
    WhatsApp: "WhatsApp",
  ...
  brandList: {
    title: "브랜드",
    description:
      "세라믹 및 건축자재 업계의 각 브랜드가 선보이는 최신 제품을 둘러보세요.",
  },
  mainPrograms: {
    title: "<span class=''>주요</span> <span class=''>프로그램</span>",
    description:
      "전시, 비즈니스 컨퍼런스, 세미나, 비즈니스 매칭까지. {appName}에서 업계 핵심 인사들과 만나보세요.",
    items: {
      "0": {
        title: "Exhibition",
        description:
          "인도네시아 주요 세라믹 제조사들이 최신 제품과 디자인을 선보여요. 원자재, 기계, 기술, 장비 등 업계 필수 아이템도 함께 전시돼요.",
      },
      "1": {
        title: "Opening Ceremony",
        description:
          "제23회 Megabuild Indonesia와 함께하는 개막식이에요. 산업부 장관이 개막하고, 각 기관, 협회, 커뮤니티, 미디어 귀빈이 참석해요.",
      },
      "2": {
        title: "Keramika Conference",
        description:
          "2026년 하반기 세라믹 산업 핵심 주제를 다루는 컨퍼런스예요. 전문가 연사와 업계 리더가 전시회 첫째 날, 둘째 날 등장해요.",
      },
      "3": {
        title: "1O1 - Business Matching",
        description:
          "인도네시아 세라믹 제조사와 아세안 수입업체, 신규 유통사, 프로젝트 오너를 연결해 드려요. 원자재, 기술, 기계 공급업체 매칭도 진행해요.",
      },
      "4": {
        title: "Power Networking Night",
        description:
          "기업 오너, 경영진, 협회 리더, 업계 관계자를 위한 디너 & 네트워킹이에요. 여기서 만난 인연이 새로운 협업으로 이어져요.",
      },
      "5": {
        title: "Hosted Buyer Program",
        description:
          "아세안 각국에서 타겟 바이어와 파트너를 초청해 참가사와 매칭해요. 자격을 갖춘 업계 관계자의 숙박은 주최 측이 전액 부담해요.",
      },
      "6": {
        title: "The Beauty of Indonesia Ceramics Installation",
        description:
          "바닥 타일, 위생도기, 지붕재, 테이블웨어까지. 인도네시아 세라믹 최고 디자인을 모은 큐레이션 전시예요.",
      },
      "7": {
        title: "Professional & Student Visit",
        description:
          "싱가포르, 말레이시아, 인도네시아의 건축가, 인테리어 디자이너, 컨설턴트, 디자인 학생, 교수를 초청해 최신 세라믹을 직접 체험할 수 있는 프로그램이에요.",
      },
      "8": {
        title: "Brand Talks",
        description:
          "팟캐스트 스타일 세션으로 참가 브랜드의 최신 제품, 디자인, 기술을 이야기해요. 브랜드마다 30분 전용 시간이 주어져요.",
      },
      "9": {
        title: "Ceramics Artistic Showcase",
        description:
          "도예 작가들이 현지 점토로 전통과 현대 도자기 제작 기법을 시연해요. 관람객도 직접 체험해 볼 수 있는 라이브 데모예요.",
      },
      "10": {
        title: "Designer Workshops",
        description:
          "인도네시아 건축사 협회(IAI), 인도네시아 인테리어 디자이너 협회(HDII)와 함께 전시회 참가 회원들을 위한 워크숍과 교육 프로그램을 진행해요.",
      },
      "11": {
        title: "Building Contractors & Property Developers Members Gathering",
        description:
          "인도네시아 부동산 협회(REI), 인도네시아 건설업 협회(AKI)와 공동 진행하는 행사예요. 전시회 기간 중 회원 간 네트워킹과 지식 공유의 장이에요.",
      },
      "12": {
        title: "Seminars, Forum, Talkshows",
        description:
          "Tender Indonesia, Archinesia, Indonesia Design 등 미디어 파트너와 함께해요. 업계 인사이트와 심도 있는 토론이 펼쳐져요.",
      },
      "13": {
        title: "Jakarta Design Week 2026",
        description:
          "인도네시아 건축사 협회(IAI) 및 자카르타 특별주 정부와 협력해, 건축과 도시의 미래를 주제로 한 포럼과 컨퍼런스를 열어요.",
      },
      "14": {
        title: "Floor & Wall Tile Installation Competition",
        description:
          "타일 시공 기술자들이 Keramika 참가사 제품으로 실력을 겨뤄요. 기술과 장인 정신을 뽐내고 상금 500만 루피아에 도전하세요.",
      },
      "15": {
        title: "Keramika Charity",
        description:
          "참가사들이 엄선한 제품을 관람객에게 판매하고, 수익금 전액을 자선 단체에 기부해요. 쇼핑하면서 좋은 일에도 동참할 수 있어요.",
      },
      "16": {
        title: "Keramika Awards 2026",
        description:
          "인도네시아 세라믹 산업의 우수한 성과를 인정하는 시상식이에요. HDII, IAI, GBCI와 함께 최우수 디자인, 마감, 컬러 등 부문별 시상을 해요.",
      },
      "17": {
        title: "Keramika Best Booth",
        description:
          "네 가지 카테고리에서 부스 창의성을 시상해요: 대형(108m² 초과), 중형(50~108m²), 소형(50m² 미만), 그리고 관람객 투표로 뽑는 인기 부스.",
      },
    },
  },
  factsAndFigures: {
    ...
    description:
      "Keramika Indonesia는 21회에 걸쳐 수천 개 세라믹 기업의 성장과 새로운 기회를 만들어 왔어요.",
    stats: {
      visitors: {
        label: "총 방문자",
        description: "45개국 출신",
  ...
  partnerships: {
    title:
      "<span class=''>Keramika와 </span><span class='text-primary'>함께하세요</span>",
    description:
      "{appName}에 참여해서 잠재 파트너를 만나고, 브랜드를 알리고, 네트워크를 넓혀보세요.",
    exhibitor: {
      title: "전시업체 등록",
      description:
        "브랜드와 기업 여러분, 수천 명의 관람객과 업계 바이어에게 제품을 선보이세요.",
      cta: "부스 예약하기",
    },
    sponsor: {
      title: "스폰서 등록",
      description:
        "ASEAN 세라믹 업계 대표 행사의 스폰서가 되어 핵심 의사결정권자들과 연결되세요.",
      cta: "스폰서 문의",
    },
    mediaPartner: {
      title: "미디어 파트너 등록",
      description:
        "세라믹 업계 최대 행사를 독점 취재할 수 있는 파트너십 기회예요.",
      cta: "미디어 파트너 신청",
    },
    reservedSpace: {
  ...
  bookSpace: {
    title: "전시 참가 신청",
    description:
      "{appName}에서 부스를 확보하고 수천 명의 관람객과 바이어에게 브랜드를 선보이세요.",
  },
  faq: {
    title: "자주 묻는 질문",
  ...
  pages: {
    home: {
      ...
      description:
        "ASEAN 최대 세라믹 전시회에서 최신 기술, 소재, 디자인 트렌드를 만나보세요.",
    },
    brands: {
      title: "브랜드",
      description:
    ...
    faq: {
      title: "FAQ",
      description:
        "{appName}에 대해 자주 묻는 질문을 확인해 보세요. 티켓, 행사 정보, 파트너십 등에 관한 답변을 모았어요.",
    },
    links: {
      title: "Links",
    ...
    news: {
      title: "News",
      description:
        "세라믹 업계의 최신 소식과 트렌드를 확인하세요. 전문가 칼럼과 행사 소식도 읽어보세요.",
    },
    ticketPolicy: {
      title: "티켓 정책",
      description:
    ...
    eventPolicy: {
      title: "행사 정책",
      description:
        "{appName}의 행사 규정과 참가자 및 전시 참가사를 위한 주요 안내 사항을 확인해 보세요.",
    },
    partners: {
      title: "파트너",
      description:
        "파트너, 스폰서, 미디어의 든든한 지원 덕분에 이 행사를 만들 수 있어요. 함께해 주신 분들께 감사드려요.",
    },
    terms: {
      title: "이용약관",
      description: "",
    ...
    winner: {
      title: "랜덤 추첨기",
      description:
        "랜덤 추첨기로 당첨자를 바로 뽑아보세요. 이름을 입력하고 슬롯을 돌려서 공정하게 추첨해요. 콘테스트, 경품 이벤트에 딱이에요!",
    },
  },
};
