  ...
  const components = computed(() => ({
    hero: {
      ...
      bannerHero: [
        ...
        // },
        {
          ...
          adImage: {
            src: "/img/banners/banner-hero/conversions/km-banner-ceramics-sm.jpg",
            srcFull: "/img/banners/banner-hero/km-banner-ceramics.jpg",
            alt: "Ceramics",
          },
          // link: "",
        },
    ...
    mainPrograms: {
      ...
      list: [
        ...
        {
          title: t("mainPrograms.items.16.title"),
          description: t("mainPrograms.items.16.description"),
        },
        {
          title: t("mainPrograms.items.17.title"),
          description: t("mainPrograms.items.17.description"),
        },
      ],
    },
