  ...
  state: () => ({
    ...
    components: {
        ...
        bannerHero: [
          {
            ...
            content: `
              <p>Discover the latest technology, solutions, materials and design trends from hundreds of leading ceramic brands. Get free access to expert consultations and exclusive insights.</p>
            `,
            cta: {
          ...
          },
          {
            ...
            content: `
              <p>Position your brand in front of thousands of industry professionals, architects, and decision-makers. Connect with key players and expand your business network.</p>
            `,
            cta: {
          ...
          },
          {
            ...
            content: `
              <p>Join industry leaders and experts in insightful discussions about sustainable ceramics, cutting-edge technology, and future trends shaping the ceramic industry.</p>
            `,
            cta: {
              label: "See Event Programs",
              link: "/programs",
            },
          },
          {
            ...
            content: `
            <p>Follow our social media for the latest ceramic innovations, exhibitor highlights, and exclusive updates leading up to the event. Be part of the conversation!</p>
          `,
            cta: {
              label: "Follow @keramikaid",
      ...
      brandList: {
        title: "Brands",
        description:
          "Explore the diverse range of brands showcasing the latest innovations and products in the ceramic industries.",
      },
        ...
        list: [
          {
            title: "Exhibition",
            description:
              "Featuring Indonesia's top ceramic manufacturers with their latest products and designs, alongside essential industry needs, from raw materials and machinery to cutting-edge technology and equipment.",
          },
          {
            title: "Opening Ceremony",
            description:
              "Join the grand opening alongside the 23rd Megabuild Indonesia, inaugurated by the Ministry of Industry and attended by distinguished guests from institutions, associations, communities, and media.",
          },
          {
            title: "Keramika Conference",
            description:
              "Dive into relevant ceramic industry topics for the second half of 2026. Featuring expert speakers and industry leaders, this conference runs on the first and second days of the exhibition.",
          },
          {
            title: "1O1 - Business Matching",
            description:
              "Connecting Indonesian ceramic manufacturers with ASEAN importers, new distributors, and project owners. We also link suppliers of raw materials, technology, and machinery with manufacturers across the region.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Inviting architects, interior designers, consultants, design students, and lecturers from Singapore, Malaysia, and Indonesia to explore the exhibition and discover the latest in ceramic innovation.",
          },
          {
            title: "Brand Talks",
            description:
              "Podcast-style sessions discussing the latest products, designs, technologies, and innovations from participating brands. Each brand gets a dedicated 30-minute spotlight to share their story.",
          },
          {
            title: "Ceramics Artistic Showcase",
            description:
              "Watch ceramics artists demonstrate traditional and modern pottery-making techniques using local clay. Live demos feature various tools and materials, inspiring visitors to try their hand at the craft.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Featuring media partners like Tender Indonesia, Archinesia, and Indonesia Design, these sessions attract the ceramic exhibition's target audience with valuable insights and industry discussions.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Tile installers compete using products from Keramika exhibitors. Showcase your skills and craftsmanship for a chance to win a cash prize of 5 million rupiah.",
          },
          {
            title: "Keramika Charity",
            description:
              "Exhibitors donate specially selected products to be sold to visitors, with all proceeds going directly to charitable foundations. Shop for great products while supporting a good cause.",
          },
          {
            title: "Keramika Awards 2026",
            description:
              "Recognizing excellence in Indonesia's ceramic industry. In partnership with HDII, IAI, and GBCI, we honor outstanding achievements in categories like Best Design, Best Finishes, Color, and more.",
          },
          {
      ...
      factsAndFigures: {
        ...
        description:
          "The facts & figures gathered from 21 editions are testament to the powerful platform that Keramika Indonesia has provided for thousands of businesses to grow.",
      },
