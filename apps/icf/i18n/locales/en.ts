export default {
  ...
  mainPrograms: {
    ...
    items: {
      ...
      "1": {
        title: "Tasting Bars",
        description:
          "Sample hundreds of products from coffee, tea, wine, and chocolate exhibitors. Your next favorite cup is somewhere in here.",
      },
      "2": {
  ...
  visitorCta: {
    ...
    description:
      "Your coffee pass also gets you into FLEI and MoreFood Expo next door. Same venue, four days to explore it all.",
    cta: "Get Ticket",
  },
  mediaCoverage: {
  ...
  pages: {
    home: {
      ...
      description:
        "Join the Indonesia Coffee Festival, a vibrant celebration of the nation's coffee culture. Explore tastings, workshops, competitions, and more. Get your tickets now!",
    },
    brands: {
      title: "Brands",
      description:
        "Discover a diverse array of brands showcasing their products and innovations at the {appName}. From coffee and tea to bakery, dessert, and more, explore what each brand has to offer.",
    },
    rundown: {
      title: "Rundown",
      description:
    ...
    news: {
      title: "News",
      description:
        "Stay updated with the latest insights, news, and trends in the coffee and F&B industry. Read our blog for expert articles and event updates.",
    },
    ticketPolicy: {
      title: "Ticket Policy",
      description:
