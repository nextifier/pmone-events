export default defineNuxtConfig({
  ...
  i18n: {
    ...
    baseUrl: "https://indocoffeefestival.com",
    defaultLocale: "en",
  ...
  pwa: {
    manifest: {
      ...
      short_name: "ICF",
      description:
        "Festival kopi terbesar di Indonesia. Jelajahi ragam kopi nusantara, peralatan brewing, dan peluang bisnis di industri kopi.",
    },
  },
  ...
  nitro: {
    ...
    // `npx wrangler --cwd apps/icf/.output deploy`. wrangler.name sets the
