  ...
  >
    ...
    <div class="container-wider relative z-20">
      ...
      >
          ...
          <div class="flex flex-col items-start">
            ...
            <div class="mt-6 flex w-full gap-2 md:flex-wrap md:gap-3">
              <nuxt-link
                ...
                class="bg-primary text-primary-foreground hover:bg-accent/80 flex items-center justify-center rounded-xl px-4 py-3 font-semibold tracking-tight transition active:scale-95 lg:rounded-2xl lg:px-6 lg:py-3"
                v-ripple
        ...
        <div
          class="relative isolate z-10 order-2 md:order-last md:col-span-2 md:pt-6 lg:pb-10 xl:order-2 xl:col-span-1 2xl:pt-10 2xl:pb-16"
        >
          <HeroVisual />
        </div>
