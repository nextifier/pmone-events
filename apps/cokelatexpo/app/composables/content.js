...
export const useContentStore = defineStore("content", {
  state: () => ({
    pages: {
      ...
      brands: {
        title: `Brands`,
        description: `Discover a diverse array of brands showcasing their products and innovations at the ${useAppConfig().app.name}.`,
    ...
    `,
          ...
          // {
          //   subHeadline: "Pro Tip: Come Thirsty!",
          //   content: `
          //     <p>With hundreds of coffee, tea, and wine samples, you'll want to pace yourself. Stay hydrated and get ready for a marathon of amazing flavors!</p>
          //   `,
          //   cta: {
          //     label: "See Who's Coming",
          //     link: "/brands",
          //   },
          // },
          {
