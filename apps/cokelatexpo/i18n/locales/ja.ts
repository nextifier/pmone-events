export default {
  ...
  "mainPrograms": {
    ...
    "items": {
      ...
      "1": {
        "title": "テイスティングバー",
        "description": "コーヒー、お茶、ワイン、チョコレート。出展者の製品を無料で試飲・試食して、お気に入りを見つけてください。"
      },
      "2": {
        "title": "ハンズオンワークショップ",
  ...
  "visitorCta": {
    "title": "今年<span class=\"text-accent\">最大のチョコレートの祭典</span>。<span class=\"text-accent\">入場無料</span>です。",
    "description": "試食、ワークショップ、新しい出会い。すべてチケットで楽しめます。",
    "cta": "チケットを取得"
  },
  "mediaCoverage": {
    "title": "メディア掲載",
