export default {
  ...
  visitorCta: {
    ...
    description:
      "チョコレートのチケットで、隣のFLEIとIOITEにもそのまま入れます。会場はNICE PIK 2。",
    cta: "チケットを取得",
  },
  eventStats: {
    subtitle: "これまでの実績",
  ...
  faq: {
    ...
    items: {
      ...
      "1": {
        q: "チケットはどこで入手できますか？",
        a: '<p>当サイトの<a href="/tickets">チケット取得</a>ボタンから登録してください。Eチケットがメールとwhatsappに届きます。</p>',
      },
      "2": {
        q: "チケットの料金はいくらですか？",
        a: '<p>種類や購入時期で異なります。最新の料金は<a href="/tickets">チケットページ</a>でご確認ください。早割やプレセール割引もあります。</p>',
      },
      "3": {
