...
export const useNewsCoveragesStore = defineStore("newsCoverages", {
  state: () => ({
    list: [
      ...
      // {
      //   title:
      //     "Coffee Lovers, Merapatlah! Indonesia Coffee Festival 2025 Digelar, Dorong Geliat Kopi Nusantara",
      ...
      // },
      // {
      //   title: "Indonesia Coffee Festival Siap Digelar Tahun Ini",
      ...
      // {
      //   title:
      //     "Indonesia Coffee Festival and Cafe n' Brasserie Expo 2025 Siap Digelar",
